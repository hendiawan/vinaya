    ...
    <div class="fluid form-horizontal">             
        <div class="widget leftcontent grid12">
            <div class="widget-header">
                <h3 class="widget-title">INFORMASI PENJUALAN SATU BULAN</h3>
            </div> 
            <div class="widget-content pad20f">
                ...
                @endif
                 <div class="form-group">
                    ...
                    <div class="chart-desc grid6">
                        <div class="stat-tab-title"><strong>TOTAL SETORAN</strong> (Semua Produk)</div>
            ...
            <div class="divider"></div>
             <div class="widget-header">
                <h3 class="widget-title">PENJUALAN BY MENU</h3>
            </div>
