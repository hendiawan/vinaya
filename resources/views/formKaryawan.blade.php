...
<div id="main" class="clearfix">
    <div class="secInfo">
        <h1 class="secTitle">Form Input Data Builder</h1>
        <span class="secExtra">Form penginputan Builder  Nutrition Club</span>
            ...
            <div class="topTabs">					
                <div id="topTabs-container-form">
                    ...
                    <div class="topTabsContent" style="padding-left:0;">
                        <div id="tab1">
                            <form id="form-penjualan" class="form-horizontal" method="POST" action="{{ url('/') }}/create-karyawan" enctype="multipart/form-data">
                            {!! csrf_field() !!}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <select id="jabatan" name="jabatan" class="form-control">
                                            ...
                                            <option value="Sales">Nempeler</option> 
