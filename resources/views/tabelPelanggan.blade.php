        ...
        <div id="topTabs-container-home">
            <div class="topTabs-header clearfix">
                ...
                <ul class="etabs tabs">
                    <li class="tab">
                        <a href="#tab1">
                            <span class="to-hide">
                                <i class="fa fa-folder-open"></i><br>Data Customer
                            </span>
            ...
            <div class="widget-content pad20f" style="padding-bottom:0">	
                <div class="alert alert-info" style="margin-bottom:0" role="alert">
                    ...
                    <ul style="padding-left: 20px !important;">
                        <li>Tabel dibawah memuat semua data Customer yang telah didaftarkan</li>
            ...
            <div class="widget-header">
                <div class="icon-grp" style="padding-top:10px;">
                    <a href="/pelanggan-add" class="btn btn-blue">
...
@push('scripts')
	...
	var tablePelanggan =        $("#sppsb-datatable").DataTable({
                
	        processing: true,
	        serverSide: true,
	        ajax: '{{ url("/") }}/getdata-pelanggan',
	        columns: [ 
                                  { data: 'id', name: 'id',sClass:'text-center' },
	            { data: 'nama_pelanggan', name: 'nama_pelanggan',sClass:'text-center'  }, 
                                  { data: 'tgl_lahir', name: 'tgl_lahir', sClass:'text-center' },
	            { data: 'sales.karyawan.nama_karyawan', name: 'alamat',sClass:'text-center',searchable: true  },  
...
@can('admin-access')	            { data: 'action', name: 'action', sClass:'text-center', orderable: false, searchable: false } @endcan 
	        ...
	        aaSorting: []
                       ...
                       $(document).on('click', '.po-delete-pelanggan', function () {
                                var id = $(this).attr('id');
                                $('#customLoad').show();
                                $('.popovers').popover('hide');
                                $.ajax({
                                    url: '{{ url("/") }}/delete-pelanggan/' + id,
                                    type: "GET",
                                    cache: false,
                                    data: "",
