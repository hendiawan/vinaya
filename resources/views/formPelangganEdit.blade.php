...
<div id="main" class="clearfix">
    <div class="secInfo">
        <h1 class="secTitle">Form Edit Data Pelanggan</h1>
        <span class="secExtra">Form Edit Pelanggan  Nutrition Club</span>
            ...
            <div class="topTabs">					
                <div id="topTabs-container-form">
                    ...
                    <div class="topTabsContent" style="padding-left:0;">
                        <div id="tab1">
                            <form id="form-penjualan" class="form-horizontal" method="POST" action="{{ url('/') }}/detail-pelanggan/{{$data->id}}" enctype="multipart/form-data">
                            {!! csrf_field() !!}
                            ...
                            <div class="widget-content pad20f">     
                               <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="nama_pelanggan" value="{{ old('nama_pelanggan',$data->nama_pelanggan) }}" class="form-control" id="nama_pelanggan">
                                    </div>
                                </div>   
                                <div class="form-group {{ $errors->has('tgl_lahir') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="input-group">
                                            <input id="tgl_lahir"   type="text" name="tgl_lahir" value="<?php echo old('tgl_lahir',$data->tgl_lahir) ?>" class="form-control  clearClone " placeholder="dd-mm-yyyy">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control" id="nama_coach" name="sales_id">
                                            ...
                                            @foreach($data_sales as $value) 
                                                <option @if($data->sales_id==$value->id) selected='' @endif value="{{$value->id}}">{{$value->karyawan->nama_karyawan}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                            </div>   
