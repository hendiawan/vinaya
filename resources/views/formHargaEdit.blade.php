...
<div id="main" class="clearfix">
    <div class="secInfo">
        <h1 class="secTitle">Form Edit Harga Dasar</h1>
        <span class="secExtra">Form Edit Harga Dasar Barang  Nutrition Club</span>
            ...
            <div class="topTabs">					
                <div id="topTabs-container-form">
                    ...
                    <div class="topTabsContent" style="padding-left:0;">
                        <div id="tab1">
                            <form id="form-penjualan" class="form-horizontal" method="POST" action="{{ url('/') }}/detail-harga/{{$data->id}}" enctype="multipart/form-data">
                            {!! csrf_field() !!}
                            ...
                            <div class="widget-content pad20f">     
                               <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="barang_id" id="barang_id"  class="form-control">
                                            ...
                                            @foreach($barang as $value)
                                                <option @if($data->barang_id==$value->id) selected='' @endif value="{{$value->id}}">{{$value->nama_barang}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>  
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input readonly="" type="text" name="takaran" value="{{ old('takaran',$data->takaran) }}" class="form-control" id="takaran">
                                    </div>
                                </div>  
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="harga_pokok" value="{{ old('harga_pokok',$data->harga_pokok) }}" class="form-control numeric"  id="harga_pokok">
                                    </div>
                                </div>    
                                <div class="form-group">
                                    <label for="harga_jual" class="col-sm-3 control-label">Harga Jual</label>
                                    <div class="col-sm-9">
                                        <input readonly="" type="text" name="harga_jual" value="{{ old('harga_jual',$data->harga_perporsi) }}" class="form-control numeric"  id="harga_jual">
                                    </div>
                                </div>   
                            </div> 				
