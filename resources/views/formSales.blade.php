...
<div id="main" class="clearfix">
    <div class="secInfo">
        <h1 class="secTitle">Form Input Data Coach</h1>
        <span class="secExtra">Form penginputan Coach  Nutrition Club</span>
            ...
            <div class="topTabs">					
                <div id="topTabs-container-form">
                    ...
                    <div class="topTabsContent" style="padding-left:0;">
                        <div id="tab1">
                            <form id="form-penjualan" class="form-horizontal" method="POST" action="{{ url('/') }}/create-sales" enctype="multipart/form-data">
                            {!! csrf_field() !!}
                            ...
                            <div class="widget-content pad20f">     
                               <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="iuran" value="{{ old('iuran') }}" class="form-control" id="iuran">
                                    </div>
                                </div>    
                            </div> 				
