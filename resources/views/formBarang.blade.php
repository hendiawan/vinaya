...
<div id="main" class="clearfix">
    <div class="secInfo">
        <h1 class="secTitle">Form Input Data Barang</h1>
        <span class="secExtra">Form penginputan Pembelian Dari Setiap Coach Nutrition Club</span>
            ...
            <div class="topTabs">					
                <div id="topTabs-container-form">
                    ...
                    <div class="topTabsContent" style="padding-left:0;">
                        <div id="tab1">
                            <form id="form-penjualan" class="form-horizontal" method="POST" action="{{ url('/') }}/create-barang" enctype="multipart/form-data">
                            {!! csrf_field() !!}
                            ...
                            <div class="widget-content pad20f">     
                               <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="nama_barang" value="{{ old('nama_barang') }}" class="form-control" id="nama_barang">
                                    </div>
                                </div> 
                                <div class="form-group">
                                    <label for="netto" class="col-sm-3 control-label">Netto</label>
                                    <div class="col-sm-9">
                                        <input   type="text" name="netto" value="{{ old('netto') }}" class="form-control" id="netto">
                                    </div> 
                                </div> 
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="takaran" value="{{ old('takaran') }}" class="form-control" id="takaran">
                                    </div>
                                </div>   
                                <div class="form-group">
