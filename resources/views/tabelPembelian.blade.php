        ...
        <div id="topTabs-container-home">
            <div class="topTabs-header clearfix">
                ...
                <ul class="etabs tabs">
                    <li class="tab">
                        <a href="#tab1">
                            <span class="to-hide">
                                <i class="fa fa-folder-open"></i><br>Data Stok Barang
                            </span>
            ...
            <div class="widget-content pad20f" style="padding-bottom:0">	
                <div class="alert alert-info" style="margin-bottom:0" role="alert">
                    ...
                    <ul style="padding-left: 20px !important;">
                        <li>Tabel dibawah memuat semua data stok yang telah dinput</li> 
                    </ul>
                </div>
            </div>
            ...
            <div class="widget-header">
                <div class="icon-grp" style="padding-top:10px;">
                    <a href="/pembelian" class="btn btn-blue">
                        <i class="fa fa-user-plus"></i> Tambah Stok
                    </a>
                </div>
            </div>
...
@push('scripts')
	...
	$(document).ready(function() {
	 ...
	 var tablePembelian =     $("#sppsb-datatable").DataTable({
                
	        processing: true,
	        serverSide: true,
	        ajax: '{{ url("/") }}/getdata-pembelian',
	        columns: [
                                
//                                  { data: 'id', name: 'id',sClass:'text-center' },
	            { data: 'tgl_beli', name: 'tgl_jual',sClass:'text-center'  }, 
	            { data: 'sales.karyawan.nama_karyawan', name: 'pembelian.sales.karyawan.nama_karyawan',sClass:'text-center',searchable: true  }, 
	            { data: 'barang.nama_barang', name: 'pembelian.barang.nama_barang',sClass:'text-center',searchable: true  }, 
	            { data: 'qty', name: 'qty', sClass:'text-center' },
	            { data: 'harga_pokok', name: 'harga_pokok', sClass:'text-center' ,
	        ...
	        aaSorting: []
                      ...
                      $(document).on('click', '.popovers', function (e) {
                       ...
                       $(document).on('click', '.po-delete-pembelian', function () {
                                var id = $(this).attr('id');
                                $('#customLoad').show();
                                $('.popovers').popover('hide');
                                $.ajax({
                                    url: '{{ url("/") }}/delete-pembelian/' + id,
                                    type: "GET",
                                    cache: false,
                                    data: "",
