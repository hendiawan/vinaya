...
<div id="main" class="clearfix">
    <div class="secInfo">
        <h1 class="secTitle">Form Edit Detail Menu</h1>
                        ...
                        <div id="tab1">
                            ...
                            <div class="widget-content pad20f">     
                               <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input  readonly=""  type="text" name="harga" value="{{ old('harga',$data->menu->harga) }}" class="form-control numeric" id="harga">
                                    </div> 
                                </div>  
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input readonly=""  type="text" name="harga_jual" value="{{ old('harga_jual',$data->menu->harga_jual) }}" class="form-control numeric" id="harga_jual">
                                    </div> 
                                </div>   
                            </div>
                            ...
                            <div class="widget-content pad20f">     
                              <div class="form-group">
                                    ...
                                    <input type="text" name="takaran" value="{{ old('takaran',$data->barang->takaran) }}" class="form-control hidden" id="takaran"> 
