...
<div id="main" class="clearfix">
    <div class="secInfo">
        <h1 class="secTitle">Form Edit Paket </h1>
        <span class="secExtra">Form Edit  untuk setiap paket yang dibeli oleh pelanggan</span> 
    </div> <!-- /SecInfo -->
    <div class="fluid">				
                ...
                <div id="topTabs-container-form">
                    ...
                    <div class="topTabsContent" style="padding-left:0;">
                        <div id="tab1"> 
                            ...
                            <form id="form-penjualan" class="form-horizontal" method="POST" action="{{ url('/') }}/detail-paket/{{$data->id}}" enctype="multipart/form-data">
                            {!! csrf_field() !!}
                                 ...
                                 <div class="form-group {{ $errors->has('nama_member') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-sm-9">
                                        <select id="member" name="pelanggan_id" class="form-control">
                                            <option value="{{$data->pelanggan->id}}">{{$data->pelanggan->nama_pelanggan}}</option> 
                                    </select>
                                    </div>
                                </div>
                            </div> 	   
                               ...
                               <div class="form-group">
                                    ...
                                    <div class="col-sm-9"> 
                                        <select name="menu_id" class="form-control" id="nama_menu">
                                            <option value="{{$data->menu->id}}">{{$data->menu->nama_menu}}</option>
                                        </select>
                                    </div>
                                </div> 
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input  readonly=""  type="text" name="harga" value="{{ old('harga',$data->menu->harga) }}" class="form-control  text-right numeric" id="harga">
                                    </div> 
                                </div>  
                                <div class="form-group">
                                    <label for="qty" class="col-sm-3 control-label">Qty</label>
                                    <div class="col-sm-9">
                                        <input readonly="" type="text" name="qty" value="{{ old('qty',$data->menu->qty) }}" class="form-control" id="qty">
                                    </div>
                                </div>   
                                <div class="form-group">
                                    <label for="harga_jual" class="col-sm-3 control-label">Harga Jual Per Porsi</label>
                                    <div class="col-sm-9">
                                        <input readonly=""  type="text"   value="{{ old('harga_jual',$data->menu->harga_jual) }}" class="form-control  text-right numeric" id="harga_jual">
                                        <input  class="numeric hidden"   type="text" name="harga_jual" value="{{ old('harga_jual',$data->menu->harga_jual)}}"   id="harga_jual_save">
                                    </div> 
                                </div>   
                                <div class="form-group">
                                    <label for="masa_kadaluarsa" class="col-sm-3 control-label">Masa Kadaluarsa</label>
                                    <div class="col-sm-9">
                                        <input readonly=""  type="text" name="masa_kadaluarsa" value="{{ old('masa_kadaluarsa',$data->menu->kadaluarsa) }}" class="form-control  text-right " id="masa_kadaluarsa"> Bulan
                                    </div> 
                                </div>   
                            </div>
                            ...
                            <div class="widget-content pad20f">     
                              <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input readonly="" type="text" name="total_bayar" value="{{ old('total_bayar',$data->total_bayar) }}" class="form-control numeric" id="total_bayar">  
                                    </div>  
                                </div>  
                              <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control" name="status_paket" id="status_paket">
                                            ...
                                            <option @if($data->status=='umum') selected='' @endif value="umum">Umum</option>  
                                            <option @if($data->status=='aktif') selected='' @endif  value="aktif">Aktif</option>  
                                            <option @if($data->status=='nonAktif') selected='' @endif  value="nonAktif">Non Aktif</option>  
                                            <option @if($data->status=='habis') selected='' @endif  value="habis">Habis</option>  
                                        </select>
                                    </div>  
                                </div>  
                              <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control" name="status_bayar" id="status_bayar">
                                            ...
                                            <option @if($data->bayar=='hutang') selected='' @endif  value="hutang">Hutang</option>  
                                            <option @if($data->bayar=='lunas') selected='' @endif value="lunas">Lunas</option> 
                                        </select>
                                    </div>  
                                </div>  
                            </div> 	                            
                            ...
                            <div class="widget-header">
                                <h3 class="widget-title">TANGGAL EDIT PAKET</h3>
                            </div>
                            <div class="widget-content pad20f">      
                                     <div class="form-group {{ $errors->has('tgl_transaksi') ? ' has-error' : '' }}">
                                    <label for="tgl_transaksi" class="col-sm-3 control-label">Tgl Beli <span class="text-danger">*</span></label>
                                    <div class="col-sm-4">
                                        <div class="input-group">
                                            <input readonly="" type="text" name="tgl_transaksi" value="<?php echo old('tgl_transaksi', date('d-m-Y',strtotime($data->tgl_beli))) ?>" class="form-control  clearClone tgl_transaksi " placeholder="dd-mm-yyyy">
...
//$(this).prop('disabled', true);
        ...
        var harga_jual_save = parseFloat($('#harga_jual_save').autoNumeric('get')) || 0;
//      alert(total_bayar);
        $('#harga').val(harga);
        $('#harga_jual').val(harga_jual);
        $('#harga_jual_save').val(harga_jual_save);
...
//                                      console.log(print);
              ...
              success:function (blueprint) {    
                    console.log(blueprint); 
                     ...
                     $("#harga_jual").val(formatNumber(blueprint.data[0].harga_jual)); 
                     $("#harga_jual_save").val(formatNumber(blueprint.data[0].harga_jual)); 
