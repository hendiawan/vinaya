...
<div id="main" class="clearfix">
    <div class="secInfo">
        <h1 class="secTitle">Form Edit Master Menu</h1>
        <span class="secExtra">Form Edit untk setiap menu yang dijual</span>
            ...
            <div class="topTabs">					
                <div id="topTabs-container-form">
                    ...
                    <div class="topTabsContent" style="padding-left:0;">
                        <div id="tab1">
                            <form id="form-penjualan" class="form-horizontal" method="POST" action="{{ url('/') }}/detail-menu/{{$data->id}}" enctype="multipart/form-data">
                            {!! csrf_field() !!}
                            ...
                            <div class="widget-content pad20f">     
                               <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="nama_menu" value="{{ old('nama_menu',$data->nama_menu) }}" class="form-control" id="nama_menu">
                                    </div>
                                </div> 
                                <div class="form-group">
                                    <label for="harga" class="col-sm-3 control-label">Harga</label>
                                    <div class="col-sm-9">
                                        <input   type="text" name="harga" value="{{ old('harga',$data->harga) }}" class="form-control text-right numeric" id="harga">
                                    </div> 
                                </div>  
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" name="masa_kadaluarsa" value="{{ old('masa_kadaluarsa',$data->kadaluarsa) }}" class="form-control" id="masa_kadaluarsa">Bulan
                                    </div>
                                </div>   
                                <div class="form-group">
                                    <label for="harga_jual" class="col-sm-3 control-label">Harga Jual</label>
                                    <div class="col-sm-9">
                                        <input readonly=""  type="text" name="harga_jual" value="{{ old('harga_jual',$data->harga_jual) }}" class="form-control  text-right numeric" id="harga_jual">
                                    </div> 
                                </div>  
