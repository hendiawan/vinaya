        ...
        <div id="topTabs-container-home">
            <div class="topTabs-header clearfix">
                ...
                <ul class="etabs tabs">
                    <li class="tab">
                        <a href="#tab1">
                            <span class="to-hide">
                                <i class="fa fa-folder-open"></i><br>Data Hutang
                            </span>
            ...
            <div class="widget-content pad20f" style="padding-bottom:0">	
                <div class="alert alert-info" style="margin-bottom:0" role="alert">
                    ...
                    <ul style="padding-left: 20px !important;">
                        <li>Tabel dibawah memuat semua data Hutang yang telah dimasukkan</li>  
                    </ul>
                </div>
            </div>
            ...
            <div class="widget-header">
                <div class="icon-grp" style="padding-top:10px;">
                    <a href="/hutang" class="btn btn-blue">
                        <i class="fa fa-user-plus"></i> Input Pembayaran Hutang
                    </a>
                </div>
            </div>
...
@push('scripts')
	<script>
      $(document).ready(function() {
       var tableHutang =      $("#sppsb-datatable").DataTable({ 
	        processing: true,
	        serverSide: true,
	        ajax: '{{ url("/") }}/getdata-hutang',
	        columns: [ 
                                  { data: 'tgl_bayar', name: 'tgl_bayar',sClass:'text-center' },
	            { data: 'paket.pelanggan.nama_pelanggan', name: 'paket.pelanggan.nama_pelanggan',sClass:'text-center'  }, 
	            { data: 'paket.menu.nama_menu', name: 'paket.menu.nama_menu', sClass:'text-center' }, 
                                  { data: 'debet', name: 'debet',sClass:'text-center',render:function(data){
                                          return formatNumber(data);
                                  }}, 
                                  { data: 'kredit', name: 'kredit', sClass:'text-center',render:function(data){
                                          return formatNumber(data);
                                  } },  
                                @can('admin-access')              
	...
	$(document).on('click', '.popovers', function (e) {
                       ...
                       $(document).on('click', '.po-delete-hutang', function () {
                                var id = $(this).attr('id');
                                $('#customLoad').show();
                                $('.popovers').popover('hide');
                                $.ajax({
                                    url: '{{ url("/") }}/delete-hutang/' + id,
                                    type: "GET",
                                    cache: false,
                                    data: "",
